  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Page Content */}
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gradient-to-br from-blue-50/50 via-indigo-50/50 to-purple-50/50 p-6">
          <Routes>
            <Route path="/" element={<Dashboard />} />
            <Route path="/insurance" element={<InsurancePage />} />
            <Route path="/unremitted" element={<UnremittedPage />} />
            <Route
              ...
              element={
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-600">
                    Service Class page content will be implemented here.
                  </p>
                </div>
              }
            />
            <Route
              ...
              element={
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-600">
                    Service Distribution page content will be implemented here.
                  </p>
                </div>
              }
            />
            <Route
              ...
              element={
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-600">
                    Sub Aging page content will be implemented here.
                  </p>
                </div>
              }
            />
            <Route
              ...
              element={
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-600">
                    Rejection Analysis page content will be implemented here.
                  </p>
                </div>
              }
            />
            <Route
              ...
              element={
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-600">
                    Pending Resub page content will be implemented here.
                  </p>
                </div>
              }
            />
            <Route
              ...
              element={
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-600">
                    Claim Average page content will be implemented here.
                  </p>
                </div>
              }
            />
            <Route
              ...
              element={
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-600">
                    Settlement Report page content will be implemented here.
                  </p>
                </div>
              }
            />
